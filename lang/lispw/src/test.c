...
int main(void) {
  ...
  exit_code += ensure("./examples/lexical_scope.lisp", &(atom) { .kind = NUMBER, .rc = -1, .val.as_number = 2 });
  ...
  exit_code += ensure("./examples/corecursion.lisp", &(atom) { .kind = NUMBER, .rc = -1, .val.as_number = 3 });
